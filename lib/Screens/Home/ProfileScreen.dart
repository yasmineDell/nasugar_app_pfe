...
color : Color.fromRGBO(11,44,135,1),
 padding: const EdgeInsets.only(top: 20, left: 32, right: 16, bottom: 10), // hada li djay mel fo9
             ...
             IconButton( icon: Icon(Icons.dehaze_rounded),color: Colors.white.withOpacity(0.5), onPressed: () { Navigator.of(context).push(MaterialPageRoute(builder: (context)=> NavigationDrawerWidget(),)); },),
